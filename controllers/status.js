...
module.exports = [
    {
        ...
        handler: (req, rep) => {
            ...
            return rep.headers({
                ...
                "Content-Security-Policy": "default-src 'self' aki-solutions.net; script-src 'self' aki-solutions.net; script-src-elem 'self' 'unsafe-hashes' 'sha256-QqqR1KmqVKrfiXsygsTUa+VstTb+W7ZaVzGRbJF4OLw='; script-src-attr 'self' 'unsafe-hashes' 'sha256-uv+4qa9P0a//dcb7+2OaQG1tPyzpF9Xtt/lWZ0Jigvk='; style-src 'self' https://aki-solutions.net; style-src-elem 'self' aki-solutions.net; style-src-attr 'self' 'unsafe-hashes' 'sha256-q3nqK4VzeI/SowYCYQ/tCfo056B/JMutuSpzbJbHczk=' 'sha256-EyIkcmB0sGGmsC3z7YbHN2sjpfbxZ8bVPQSsLf3EVWw=' 'sha256-GPI0AvwLxP9frcpYjtU59LpAaMAJfP/lwxArGKRa0f4=' 'sha256-NJpPoxqyRfVnPZ7BBUyaote/6HW12xZPDGLIv2SoiOA=' 'sha256-Sa4qnAYe3JDEveYr7kHEi3Fx0dq1/BUSeTM+zER/0BM=' 'sha256-N08pmMrIK3VqvN8MEzniXYzLvVxsp1nOHSWu6L69YqM=' ; img-src 'self' https://aki-solutions.net; font-src 'self'; connect-src 'self'; media-src 'self'; object-src 'self'; prefetch-src 'self'; child-src 'self'; frame-src 'self'; worker-src 'self'; frame-ancestors 'self'; form-action 'self'; block-all-mixed-content; manifest-src 'self'",
